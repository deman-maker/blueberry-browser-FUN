...
Blueberry Browser Intelligent Tab Management is a privacy-first, AI-powered browser tab management system that intelligently carries out tab and tab related operations directly from chat. It leverages a multi-tier routing system, utilizing **Flan-T5** and local Small Language Models (SLM), along with a semantic Knowledge Graph to manage tabs, workspaces, and containers with minimal latency and maximum privacy.
