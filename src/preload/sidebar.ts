...
const sidebarAPI = {
  ...
  // Tab access
  getAllTabs: () => electronAPI.ipcRenderer.invoke("get-all-tabs"),
  ...
  getRoutingMetrics: () => electronAPI.ipcRenderer.invoke("get-routing-metrics"),
  getDeviceCapabilities: () => electronAPI.ipcRenderer.invoke("get-device-capabilities"),
  processIntelligentQuery: (query: string) => electronAPI.ipcRenderer.invoke("process-intelligent-query", query),
};
