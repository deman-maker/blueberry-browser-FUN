...
export class AppMenu {
      ...
      },
      {
        ...
        submenu: [
          ...
          },
          {
            ...
            click: () => this.handleOpenTabCommands(),
          },
          { type: "separator" },
          {
  ...
  private handleOpenTabCommands(): void {
    // Send message to topbar to open command palette
    this.mainWindow.topBar.view.webContents.send("open-command-palette");
  }
